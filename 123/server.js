...
app.post('/api/games', (req, res) => {
  const { id, date, players, startingChips, buyInRubles, chipPriceRubles } = req.body;
  ...
  const insertGame = db.prepare(
    'INSERT OR REPLACE INTO games (id, date, starting_chips, buy_in_rubles, chip_price_rubles) VALUES (?, ?, ?, ?, ?)'
  );
  ...
  const tx = db.transaction(() => {
    insertGame.run(id, date, startingChips, buyInRubles, chipPriceRubles);
